...
export const VIETNAM: VisaForm = {
  id: 'tourist-visa',
  countryCode: 'VN',
  name: 'Vietnam Tourist Visa Application',
  description: 'Application for Vietnam tourist visa',
  steps: [
    {
  ...
  fields: [
    ...
    // Previous Travel History
    {
      ...
      group: 'history',
      type: 'select',
      label: 'Have you visited Vietnam before?',
      required: true,
      options: [
        { label: 'No', value: 'no' },
        { label: 'Yes', value: 'yes' }
