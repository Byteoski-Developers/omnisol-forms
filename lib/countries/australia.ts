...
export const AUSTRALIA: VisaForm = {
  id: "australia",
  countryCode: "AU",
  name: "Australia Visa Application Form",
  description: "Universal visa application form for Australia",
  documents: [
    {
      id: "passport",
      name: "Passport",
    ...
    },
    {
      ...
      description:
        "Upload scanned copy of all pages of your previous passport(s)",
      type: "default",
      required: false,
      extractableFields: [
        // First page extractions
    ...
    // Income tax return documents
    {
      ...
      description:
        "Upload your latest income tax return and computation of income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    // MSME Registration documents
    {
      ...
      description:
        "Upload your Micro, Small & Medium Enterprises registration certificate",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    // Invitation letter documents
    {
      ...
      description:
        "Upload letter of invitation (business or personal) or sponsorship declaration",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      type: "conditional",
      required: true,
      conditions: [{ questionId: "visaType", value: "permanent_residence" }],
    },
    ...
    // Employment/Superannuation
    {
      ...
      type: "conditional",
      required: false,
      conditions: [{ questionId: "previouslyWorkedInAustralia", value: "yes" }],
    },
    ...
    // Student Visa Specific
    {
      ...
      type: "conditional",
      required: true,
      conditions: [{ questionId: "visaType", value: "student" }],
    },
  ],
  ...
  fields: [
    ...
    },
    {
      ...
      showIf: {
        operator: "or",
        conditions: [{ field: "maritalStatus", value: "single" }],
      },
      options: [
        { label: "Yes", value: "yes" },
        { label: "No", value: "no" },
    ...
    // Spouse Details (shown only if married)
    {
      ...
      showIf: {
        operator: "or",
        conditions: [{ field: "maritalStatus", value: "married" }],
      },
    },
    ...
    },
    {
      ...
      showIf: {
        ...
        conditions: [
          { field: "selfPayingExpenses", value: "yes" },
          { field: "expensePayerOccupation", value: "retired" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      type: "info",
      label: "Description",
      content: ["Family information, parents detail."],
    },
    {
      id: "parentsInput",
      group: "parents" as FormGroup,
