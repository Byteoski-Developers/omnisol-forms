...
export const UNITED_KINGDOM: VisaForm = {
  ...
  documents: [
    ...
    },
    {
      ...
      description:
        "Recent statement from your demat account showing sufficient funds for your visit",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Documents showing ownership of property as proof of financial stability",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Letter from sponsor and their bank statements showing sufficient funds",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Proof of inviter’s activities – school letter, job letter, and business documents",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Proof of inviter’s income – income tax return, pay slips, accountant letter",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    // Documents for self-arranged travel
    {
      ...
      description:
        "We will arrange your hotel booking and provide a confirmation or voucher showing your accommodation details for the entire duration of your stay.",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      name: "Flight Tickets",
      description:
        "We will take care of booking your round-trip flights and provide confirmed tickets showing your travel dates and itinerary.",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "We will arrange travel insurance for your trip and provide a certificate covering the entire duration of your stay.",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    // business docs
    {
      ...
      description:
        "Business registration, invitations to meetings or conferences",
      type: "conditional",
      required: true,
      conditions: [
        {
...

    {
      ...
      description:
        "Letter from current employer stating position, salary and duration of employment",
      type: "default",
      required: true,
    },
    //study docs
    ...
    },
    {
      ...
      description:
        "Language proficiency test result (IELTS, PTE or TOEFL etc.)",
      type: "conditional",
    ...
    },
    {
      ...
      description:
        "Documentation of scholastic and extra-curricular activities",
      type: "conditional",
      required: true, // O - Optional
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Letter of Acceptance and Provincial Attestation Letter or CAQ – Canada",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Confirmation of Acceptance to Studies (CAS) – the United Kingdom",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Advance arrangement of living expenses (GIC – Canada, FTS – New Zealand, bank deposits – the UK / Europe)",
      type: "conditional",
      required: true, // R - Recommended
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Statement of purpose (SOP), covering letter, letter of explanation",
      type: "conditional",
      required: true, // R - Recommended
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Work Experience letter, pay slips, bank account statement with pay credits",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Government approvals – Labor Marker Impact Assessment (LMIA) – Canada",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Nulla Osta – Italy and as applicable in the destination country",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    // Child and Parent relationship documents
    {
      ...
      description:
        "Birth certificate proving relationship between child and parent",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Proof of contact – chat screenshots, call logs, pre wedding, wedding and post wedding photographs and any other document",
      type: "conditional",
      required: true, // R - Recommended (setting as true with "if applicable" in name)
      conditions: [
        {
    ...
    // Sponsor immigration status documents - Permanent Resident
    {
      ...
      description:
        "Passport, PR card (front and back), BRP (UK), visa authorization etc. of the sponsor",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    // Sponsor immigration status documents - Student
    {
      ...
      description:
        "School enrollment letter, passport, visa/permit/BRP, transcripts, job letter and pay slips for part time work, bank statement, accommodation proof of the sponsor",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    // Sponsor immigration status documents - Worker
    {
      ...
      description:
        "Passport, visa/permit/BRP, job letter (with detailed duties) and pay slips for work, bank statement, accommodation proof, income tax return/assessment of the sponsor",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    // Sponsor immigration status documents - Refugee
    {
      ...
      description:
        "Passport, court order/visa/permit/BRP, job letter and pay slips for work, bank statement, accommodation proof, income tax return/assessment of the sponsor",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    // Study documents for sponsor
    {
      ...
      description:
        "Admission letter from a school for the sponsor, and the documents as needed for study visa applicant",
      type: "conditional",
      required: true, // R - Recommended (setting as true with "if applicable" in name)
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Police Clearance Certificate from Passport Office for all countries lived in for more than 6 months",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    // Partner's documents
    {
      ...
      description:
        "Partner's passport all pages with travel stamps, air tickets, boarding passes",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Partner's PR card / Landing documents / CoPR / BRP / visa authorisation or Citizenship",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Series of ceremonies and celebrations organized individually or jointly",
      type: "conditional",
      required: true, // O - Optional (setting as true with "if applicable" in name)
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Documents supporting the description of development of this relationship such as social media handles, call logs, messages, chats, matrimonial ads, exchange of gifts, transfer of monies",
      type: "conditional",
      required: true, // R - Recommended (setting as true with "if applicable" in name)
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Joint bank account statements, mortgages, investments, insurance, ID's or any correspondence by third party on same address",
      type: "conditional",
      required: true, // R - Recommended (setting as true with "if applicable" in name)
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Police Clearance Certificate from Passport Office for all countries lived in for more than 6 months (for applicants above age 18)",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Sponsor's PR card / Landing documents / CoPR / BRP / visa authorisation or Citizenship",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Language proficiency test result (IELTS, CELPIP, PTE, TOEFL, TEF, TCF)",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Work experience letter describing the duration of job, duties, and compensation",
      type: "conditional",
      required: true, // M - Mandatory
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Proof of immigration status family in country of destination",
      type: "conditional",
      required: true, // O - Optional (setting as true with "if applicable" in name)
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Invitation letter, contract copy, or participation registration",
      type: "conditional",
      required: true, // R - Recommended (setting as true with "if applicable" in name)
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "If married, please provide a copy of your marriage certificate",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "If divorced, please provide a copy of your divorce certificate",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    // what is source of income of
    {
      ...
      name: "Salary Proof",
      description:
        "Salary slips, employment letter, or other proof of salary income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Business registration, tax returns, or financial statements showing business income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Partnership deed, profit sharing agreement, or other proof of partnership income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Client invoices, professional registration, or other proof of professional income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Bank statements, investment account statements, or other proof of interest and dividend income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Land ownership documents, crop sales receipts, or other proof of agricultural income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Lease agreements, rental receipts, or other proof of rental income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Pension statements, retirement account statements, or other proof of pension income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    // what is additional source of income
    {
      ...
      description:
        "Salary slips, employment letter, or other proof of additional salary income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Business registration, tax returns, or financial statements showing additional business income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Partnership deed, profit sharing agreement, or other proof of additional partnership income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Client invoices, professional registration, or other proof of additional professional income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Bank statements, investment account statements, or other proof of additional interest and dividend income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Land ownership documents, crop sales receipts, or other proof of additional agricultural income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Lease agreements, rental receipts, or other proof of additional rental income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Pension statements, retirement account statements, or other proof of additional pension income",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    // Income and Funds Documents - Question 5
    {
      ...
      description:
        "Documents proving your relationship to the financial sponsor",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Letter from the person who will financially support your trip",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    // Proprietor Documents
    {
      ...
      description:
        "Business registration (GST, Udhyam, Import Export Code etc. as applicable)",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Business bank account statements (CC/CA accounts) not issued 15 days prior to submission, with 3 to 6 months transaction history",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Personal bank account statements all banks not issued 15 days prior to submission, with 6 months transaction history",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Documentary evidence of other investments, fixed deposits, mutual funds, post office, stocks, and shares, surrender value of insurance policies",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    // Company Director Documents
    {
      ...
      description:
        "Certificate of incorporation, Memorandum and Articles of Association, ROC Form 32 as applicable",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Business registration (GST, Import Export Code etc. as applicable)",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Business Income Tax returns along with computation – last 2 years",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Personal Income Tax returns along with computation – last 2 years",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    // Professional, Independent Contractor, Freelancer, and Self-employed Documents
    {
      ...
      description:
        "Business registration / License (such as medical association, Dental Councils registrations, Certificate of Practice, Bar Association etc.) / Any contracts",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Any other form of revenue – fodder /timber/ seeds/ fruits / vegetable sale records",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    },
    {
      ...
      description:
        "Registration of agricultural implement owned – Tractor / Harvester etc.",
      type: "conditional",
      required: true,
      conditions: [
        {
    ...
    {
      id: "uk_medical_documents",
      name: "UK Medical Treatment Documents",
      description: "Letters or receipts from UK healthcare providers",
      type: "conditional",
      required: true,
      conditions: [
        {
          questionId: "ukMedicalTreatment",
          value: "yes",
        },
      ],
    },
    {
      id: "ni_number_proof",
      name: "National Insurance Number Proof",
      description:
        "Document showing your National Insurance number (e.g., NI card, letter from HMRC)",
      type: "conditional",
      required: true,
      conditions: [
        {
          questionId: "hasNINumber",
          value: "yes",
        },
      ],
    },
    {
      ...
      description: "Front and back copy of your UK driving licence",
      type: "conditional",
      required: true,
      conditions: [
        {
          questionId: "hasUKDrivingLicense",
          value: "yes",
        },
      ],
    },
    {
      id: "public_funds_documents",
      name: "Public Funds Documentation",
      description:
        "Letters or statements showing public funds received in the UK",
      type: "conditional",
      required: true,
      conditions: [
        {
          questionId: "receivedUKPublicFunds",
          value: "yes",
        },
      ],
    },
  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: "Apply for permanent residency",
    ...
    // },
    {
      ...
      group: "personal" as FormGroup,
      type: "select",
      label: `Does anyone rely on you for financial support (including dependent children or relatives)? ${FIELD_REQUIREMENTS.RECOMMENDED}`,
      required: false,
      showIf: { field: "maritalStatus", not: "single" },
      options: [
        { label: "Yes", value: "yes" },
    ...
    {
      id: "hasDependentChildrenUnder18",
      group: "personal" as FormGroup,
      type: "select",
      label: `Do you have any dependent children under 18? ${FIELD_REQUIREMENTS.RECOMMENDED}`,
      required: false,
      showIf: { field: "hasFinancialDependents", value: "yes" },
      options: [
        { label: "Yes", value: "yes" },
        { label: "No", value: "no" },
      ],
    },
    {
      ...
      showIf: {
        operator: "or",
        conditions: [{ field: "hasDependentChildrenUnder18", value: "yes" }],
      },
    },
    {
      id: "hasDependentChildrenOver18",
      group: "personal" as FormGroup,
      type: "select",
      label: `Do you have any dependent children over 18? ${FIELD_REQUIREMENTS.RECOMMENDED}`,
      required: false,
      showIf: { field: "hasFinancialDependents", value: "yes" },
      options: [
        { label: "Yes", value: "yes" },
    ...
    },
    {
      ...
      showIf: {
        operator: "or",
        conditions: [{ field: "hasDependentChildrenOver18", value: "yes" }],
      },
    },
    {
      id: "hasDependentRelatives",
      group: "personal" as FormGroup,
      type: "select",
    ...
    },
    {
      ...
      showIf: {
        operator: "and",
        conditions: [
          { field: "hasDependentRelatives", value: "yes" },
          {
            operator: "or",
            conditions: [{ field: "hasDependentRelatives", value: "yes" }],
          },
        ],
      },
    },
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: "Performance in sports/religious events/public speaker",
          value: "performance",
        },
        { label: "Other", value: "other" },
      ],
    ...
    // },
    {
      ...
      group: "purpose" as FormGroup,
      type: "select",
      label: `Is anyone traveling with you? ${FIELD_REQUIREMENTS.OPTIONAL}`,
      required: false,
      showIf: { field: "visitPurpose", value: "visitation" },
      options: [
        { label: "Yes", value: "yes" },
    ...
    {
      id: "travelCompanionDetails",
      group: "purpose" as FormGroup,
      type: "textarea",
      label: `Provide details of the person traveling with you ${FIELD_REQUIREMENTS.OPTIONAL}`,
      required: true,
      showIf: { field: "isAnyoneTravelingWithYou", value: "yes" },
    },
    {
      id: "visitingMoreThanOnePerson",
      group: "purpose" as FormGroup,
      type: "select",
      label: `Are you visiting more than one person in the UK? ${FIELD_REQUIREMENTS.OPTIONAL}`,
      required: false,
      showIf: { field: "visitPurpose", value: "visitation" },
      options: [
        { label: "Yes", value: "yes" },
    ...
    {
      id: "multipleVisitDetails",
      group: "purpose" as FormGroup,
      type: "textarea",
      label: `Provide details of the people you are visiting ${FIELD_REQUIREMENTS.OPTIONAL}`,
      required: true,
      showIf: { field: "visitingMoreThanOnePerson", value: "yes" },
    },
    {
    ...
    },
    {
      ...
      type: "textarea",
      label:
        "Any preferences or special requests (e.g. airline, hotel rating, insurance coverage)?",
      required: false,
      showIf: {
        operator: "and",
        conditions: [
    ...
    },
    {
      ...
      description:
        "Under given circumstances, you may not be eligible for this category. Please try another or contact for further details.",
      content: [],
      required: false,
      showIf: {
        operator: "and",
    ...
    },
    {
      ...
      label: "Important Information",
      description:
        "You need an authorisation to apply under this category, please contact for further details.",
      content: [],
      required: false,
      showIf: {
        operator: "and",
    ...
    },
    {
      ...
      label: "Important Information",
      description:
        "Based on the examination of employment contract and work authorisation, there may arise a demand for additional documents.",
      content: [],
      required: false,
      showIf: {
        operator: "and",
    ...
    },
    {
      ...
      label: "Important Information",
      description:
        "You may not be eligible for this program. Check other visa categories or contact for options.",
      content: [],
      required: false,
      showIf: {
        operator: "and",
    ...
    },
    {
      ...
      label: "Important Information",
      description:
        "Would you like to share partner's details for assessment? Select YES and answer the questions.",
      content: [],
      required: false,
      showIf: {
        operator: "and",
    ...
    // For other purpose
    {
      ...
      label: "Important Information",
      description:
        "You may need to contact us to understand your requirements.",
      content: [],
      required: false,
    ...
    // },
    {
      ...
      placeholder:
        "Please provide any additional information about your financial situation",
      showIf: {
    ...
    },
    {
      ...
      group: "finances" as FormGroup,
      type: "text",
      label: `Full Name of Sponsor ${FIELD_REQUIREMENTS.MANDATORY}`,
      required: true,
      placeholder: "Enter sponsor full name",
      showIf: {
        field: "selfPayingExpenses",
        value: "no",
      },
    },
    {
    ...
    {
      id: "sponsorContributionAmount",
      group: "finances" as FormGroup,
      type: "text",
      label: `How much money is the sponsor contributing toward your visit? ${FIELD_REQUIREMENTS.MANDATORY}`,
      required: true,
    ...
    {
      id: "sponsorContributionReason",
      group: "finances" as FormGroup,
      type: "textarea",
      label: `Why is the sponsor helping to pay for your visit? ${FIELD_REQUIREMENTS.MANDATORY}`,
      required: true,
      placeholder: "Explain the reason for financial help",
      showIf: {
        field: "selfPayingExpenses",
        value: "no",
      },
    ...
    },
    {
      ...
      group: "parents" as FormGroup,
      type: "DateofBirth",
      label: `What is date of birth of your Mother? ${FIELD_REQUIREMENTS.MANDATORY}`,
      required: true,
    },
    {
      id: "fatherDob",
      group: "parents" as FormGroup,
      type: "DateofBirth",
      label: `What is date of birth of your Father? ${FIELD_REQUIREMENTS.MANDATORY}`,
      required: true,
    },
    // {
    ...
    },
    {
      ...
      type: "select",
      label:
        "Do you need any pre departure or post arrival service (such as air tickets, travel insurances, forex cards, mobile SIM, booking of accommodation, package tours)?",
      required: false,
      options: [
        { label: "Yes", value: "yes" },
        { label: "No", value: "no" },
    ...
    },
    {
      ...
      type: "select",
      label:
        "What is the best method to contact you regarding your application?",
      required: false,
    ...
    },
    {
      ...
      showIf: {
        operator: "and",
        conditions: [{ field: "preferredContactMethod", value: "email" }],
      },
    },
    {
      id: "whatsappoption",
      ...
      showIf: {
        operator: "and",
        conditions: [{ field: "preferredContactMethod", value: "whatsapp" }],
      },
    },
    {
      id: "phoneoption",
      ...
      showIf: {
        operator: "and",
        conditions: [{ field: "preferredContactMethod", value: "phone_call" }],
      },
    },
    {
      ...
      type: "select",
      label:
        "Do you like to provide additional email or phone number than that you used for creating your application?",
      required: false,
      options: [
        { label: "Yes", value: "yes" },
        { label: "No", value: "no" },
