  ...
  extractableFields: [
   ...
   // country specific documents
    ...
    },
    {
      ...
      description: 'Completed DS-160 nonimmigrant visa application confirmation page',
      type: 'default',
      required: true
    },
    {
      id: 'visa_appointment_confirmation',
      name: 'Visa Appointment Confirmation',
      description: 'Confirmation of your visa interview appointment',
      type: 'default',
      required: true
    },
    {
      id: 'us_visa_photo',
      name: 'US Visa Photo',
      description: 'Photo meeting specific US visa requirements (2x2 inches, white background)',
      type: 'default',
      required: true
    },
    {
      id: 'social_media_history',
      name: 'Social Media History',
      description: 'List of social media platforms and usernames used in the past 5 years',
      type: 'default',
      required: true
    },
    {
      id: 'travel_history_usa',
      name: 'Previous US Travel History',
      description: 'Documentation of any previous travel to the United States',
      type: 'conditional',
      required: true,
      conditions: [{
        questionId: 'hasVisitedUSA',
        value: 'yes'
      }]
    },
    {
      id: 'esta_authorization',
      name: 'ESTA Authorization (if applicable)',
      description: 'Approved ESTA for Visa Waiver Program',
      type: 'conditional',
      required: true,
      conditions: [{
        questionId: 'visaType',
